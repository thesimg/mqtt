...
client.tls_set(tls_version=ssl.PROTOCOL_TLS) # mqtt.client.ssl.PROTOCOL_TLS
# set username and password
client.username_pw_set("RBE2002macbook", "RBE2002macbook")
# connect to HiveMQ Cloud on port 8883 (default for MQTT)
client.connect("19e34349420d4b38911b39f4bda2e3ff.s1.eu.hivemq.cloud", 8883)
